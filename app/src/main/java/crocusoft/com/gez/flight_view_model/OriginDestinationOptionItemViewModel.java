...
public class OriginDestinationOptionItemViewModel implements Parcelable{
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.roundtripAirItineraryPricingInfo, flags);
    ...
    protected OriginDestinationOptionItemViewModel(Parcel in) {
        ...
        this.roundtripAirItineraryPricingInfo = in.readParcelable(crocusoft.com.gez.pojo.response.flight.roundtripResponse.AirItineraryPricingInfo.class.getClassLoader());
