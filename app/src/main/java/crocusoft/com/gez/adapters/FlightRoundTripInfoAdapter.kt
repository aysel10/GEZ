...
class FlightRoundTripInfoAdapter(): RecyclerView.Adapter<FlightRoundTripInfoAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FlightRoundTripInfoAdapter.ViewHolder{
